...
// hook scaffold/link flows that resolve AGENTS_HOME/HOME for the hooks
// bucket; a test that forgets to sandbox HOME alongside AGENTS_HOME leaks
// real files into the developer's machine. See

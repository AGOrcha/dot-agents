---
name: review-pr
description: Review a PR or branch diff using the code graph for full structural context. Uses da kg (CRG embedded); optional MCP via kg serve for tool parity.
argument-hint: "[PR number or branch name]"
---

# Review PR

Perform a structured review of a pull request or branch diff using **`da kg`** for blast radius, change analysis, and bridge queries.

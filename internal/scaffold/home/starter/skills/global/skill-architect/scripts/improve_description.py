...
Please respond with only the new description text in <new_description> tags, nothing else."""
    ...
    # Safety net: if the model produced a description over the 1024-char hard limit,
    # make one fresh call that quotes the too-long version and asks for a shorter rewrite.

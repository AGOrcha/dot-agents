...
// AGENTS_HOME/HOME for reviewer identity/credential state; a test that
// forgets to sandbox HOME alongside AGENTS_HOME leaks real files into the
// developer's machine. See internal/testutil/homeguard.go and
